import torch
from ASR.src.solver import BaseSolver

from ASR.src.asr import ASR
from ASR.src.optim import Optimizer
from ASR.src.data import load_dataset
from ASR.src.util import human_format, cal_er, feat_to_fig
...
class Solver(BaseSolver):
    ...
    def fetch_data(self, data): #augment
